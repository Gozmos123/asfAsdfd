...
<div class="modal fade" id="modal_edit_profile" tabindex="-1" role="dialog" aria-labelledby="modalEditProfile" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="needs-validation" novalidate id="form_edit_profile" action="../functions/auth/UpdateUserProfile.php" method="post">
                <!-- username -->
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="contact_no" pattern="[0-9]{11}" value="" name="contact_no">
                            <div class="invalid-feedback">
