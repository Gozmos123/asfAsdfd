        ...
        background: linear-gradient(to right, #243B55, #141E30); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */ ">
          ...
          <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
              <div class="sidebar-brand-icon mt-4">
                  <img src="../resources/images/sys_logo.png" alt="Logo" width="60px" height="60px">
              </div>
          </a>
          <center>
          ...
          <li class="nav-item">
              ...
              <div id="collapseResidents" class="collapse" aria-labelledby="headingResidents" data-parent="#accordionSidebar">
                  <div class="bg-white py-2 collapse-inner rounded">
                      ...
                      <a class="collapse-item" href="mothers.php">Mothers</a>
                      <a class="collapse-item" href="childrens.php">Childrens</a>
                  </div>
              </div>
          </li>
          ...
          <li class="nav-item">
              ...
              <div id="collapseDistributions" class="collapse" aria-labelledby="headingDistributions" data-parent="#accordionSidebar">
                  <div class="bg-white py-2 collapse-inner rounded">
                      <!-- <h6 class="collapse-header">Custom Components:</h6> -->
                      <a class="collapse-item" href="vitamins.php">Vitamins</a>
                      <a class="collapse-item" href="deworming.php">Deworming</a>
                  </div>
              </div>
          </li>
          ...
          <li class="nav-item">
              ...
              <div id="collapseMonitoring" class="collapse" aria-labelledby="headingMonitoring" data-parent="#accordionSidebar">
                  <div class="bg-white py-2 collapse-inner rounded">
                      <!-- <h6 class="collapse-header">Custom Components:</h6> -->
                      <a class="collapse-item" href="weights.php">Weights</a>
                      <a class="collapse-item" href="immunizations.php">Immunizations</a>
                  </div>
              </div>
          </li>
