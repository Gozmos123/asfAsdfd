...
<div class="modal fade" id="modal_edit_children" tabindex="-1" role="dialog" aria-labelledby="modalEditChildren" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-content">
            ...
            <form class="needs-validation" novalidate action="index.php" method="post">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="btn_update_children" name="request_update_children">Update</button>
                </div>
            </form>
        </div>
    </div>
