                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="prefix" value="<?php echo $user[0]['prefix']; ?>" placeholder="e.g. Jr." name="prefix" maxlength="5">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="contact_no" pattern="[0-9]{11}" value="<?php echo $user[0]['contact_no']; ?>" name="contact_no" maxlength="11">
                            <div class="invalid-feedback">
